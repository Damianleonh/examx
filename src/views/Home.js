...
const Home = ({ navigation }) => { // eslint-disable-line
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.optionsMenu}>
        <Pressable
          ...
          onPress={() => navigation.navigate("CrearPlantilla")} // eslint-disable-line
        >
          <LinearGradient
        ...
        <Pressable
          style={styles.cardOpcion}
          onPress={() => navigation.navigate("VerPlantillas")} // eslint-disable-line
        >
          <LinearGradient
            colors={["#8C4DE9", "#0083B0"]}
            start={{ x: 1, y: 0 }}
        ...
        <Pressable
          style={styles.cardOpcion}
          onPress={() => navigation.navigate("Alumnos")} // eslint-disable-line
        >
          <LinearGradient
            colors={["#8C4DE9", "#0083B0"]}
            start={{ x: 1, y: 0 }}
        ...
        <Pressable
          style={styles.cardOpcion}
          onPress={() => navigation.navigate("AplicarExamen")} // eslint-disable-line
        >
          <LinearGradient
            colors={["#8C4DE9", "#0083B0"]}
            start={{ x: 1, y: 0 }}
      ...
      <Text style={styles.titulo2}>Examenes en curso</Text>
