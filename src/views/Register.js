...
const Registro = ({ modalRegistro, setModalRegistro }) => { // eslint-disable-line
    ...
    createUserWithEmailAndPassword(auth, correo, password)
      ...
      .catch((err) => {
        if (err.code === "auth/invalid-email") {
          ...
          Alert.alert("Error", "La contraseña es debil");
        } else if (err.code === "auth/email-already-in-use") {
          Alert.alert("Error", "La cuenta ya existe");
        } else {
          Alert.alert("Error", "Error al registrar", err);
        }
        console.log(err);
        return;
      });
  ...
  return (
    <SafeAreaView>
      ...
      >
        <Text style={styles.textoBtnRegresar}>Cancelar</Text>
      </Pressable>

      <Image style={styles.imagen} source={require("../img/logo.jpg")} />  {/* eslint-disable-line */} 
      ...
      <View style={styles.contenedorBtnInputs}>
        ...
        <View style={styles.contenedorBotones}>
          {/* Boton registrar */}
          <Pressable style={styles.button} onPress={() => crearUsuario()}>
      ...
      {/* Ultima imagen */}
      <Image source={require("../img/BOTTOMAPP.png")} /> {/* eslint-disable-line */}
    </SafeAreaView>
  );
};
